...
router.post("/shift_available", handleCatchPromise(timetableController.findShiftsAvailable));
router.post("", handleCatchPromise(timetableController.create));
router.put("/:id", handleCatchPromise(timetableController.update));
router.put("/add_customer/:id", handleCatchPromise(timetableController.addCustomer));
